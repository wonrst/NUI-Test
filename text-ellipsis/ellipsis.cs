...
namespace TextComponentsTest
{
    class Example : NUIApplication
    {
        ...
        public void Initialize()
        {
            ...
            // label RTL
            var labelStartRTL = NewTextLabelRTL();
            labelStartRTL.EllipsisPosition = EllipsisPosition.Start;
            view.Add(labelStartRTL);

            var labelMiddleRTL = NewTextLabelRTL();
            labelMiddleRTL.EllipsisPosition = EllipsisPosition.Middle;
            view.Add(labelMiddleRTL);

            var labelEndRTL = NewTextLabelRTL();
            labelEndRTL.EllipsisPosition = EllipsisPosition.End;
            view.Add(labelEndRTL);

            // field
            var fieldStart = NewTextField();
            fieldStart.EllipsisPosition = EllipsisPosition.Start;
            view.Add(fieldStart);

            var fieldMiddle = NewTextField();
            fieldMiddle.EllipsisPosition = EllipsisPosition.Middle;
            view.Add(fieldMiddle);

            var fieldEnd = NewTextField();
            fieldEnd.EllipsisPosition = EllipsisPosition.End;
            view.Add(fieldEnd);

            // field RTL
            var fieldStartRTL = NewTextFieldRTL();
            fieldStartRTL.EllipsisPosition = EllipsisPosition.Start;
            view.Add(fieldStartRTL);

            var fieldMiddleRTL = NewTextFieldRTL();
            fieldMiddleRTL.EllipsisPosition = EllipsisPosition.Middle;
            view.Add(fieldMiddleRTL);

            var fieldEndRTL = NewTextFieldRTL();
            fieldEndRTL.EllipsisPosition = EllipsisPosition.End;
            view.Add(fieldEndRTL);
            ...
            // editor RTL
            var editorStartRTL = NewTextEditorRTL();
            editorStartRTL.EllipsisPosition = EllipsisPosition.Start;
            view.Add(editorStartRTL);

            var editorMiddleRTL = NewTextEditorRTL();
            editorMiddleRTL.EllipsisPosition = EllipsisPosition.Middle;
            view.Add(editorMiddleRTL);

            var editorEndRTL = NewTextEditorRTL();
            editorEndRTL.EllipsisPosition = EllipsisPosition.End;
            view.Add(editorEndRTL);
        }
        ...
        public TextField NewTextFieldRTL()
        {
            TextField field = new TextField
            {
                Text = " مرحبا بالعالم مرحبا بالعالم مرحبا بالعالم مرحبا بالعالم مرحبا بالعالم مرحبا بالعالم مرحبا بالعالم مرحبا بالعالم مرحبا بالعالم",
